...
np.save('Abl_11400_dihedral.npy',Abl_dihedral)
np.save('Src_11401_dihedral.npy',Src_dihedral)
...
plt.savefig('new_sims_abl_src_DFG_dihedral_hist.eps',format='eps',dpi=1000)
