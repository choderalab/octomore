...
Abl = [A for A in Abl_dihedral]
Src = [S for S in Src_dihedral]

sns.distplot(Abl, color="r",label="Abl")
sns.distplot(Src, color="b",label="Src")
plt.xlabel('Dihedral (radians)')
plt.ylabel('Occupancy')
plt.legend()

plt.savefig('abl_src_DFG_dihedral_hist-no_rotate.eps',format='eps',dpi=1000)
